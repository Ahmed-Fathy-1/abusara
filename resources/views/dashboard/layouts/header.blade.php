<nav class="header print:hidden">
    {{-- <img src="{{asset('assets/images/logo-05.png')}}" alt="" width="150" height="60"> --}}
    ...
    <div
      ...
      <div class="flex w-full items-center justify-between">
          ...
          <div class="h-7 w-7">
            <button class="sidebar-toggle ml-0.5 flex h-7 w-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80">
              <span></span>
              <span></span>
              <span></span>
            </button>
        ...
        <div class="-mr-1.5 flex items-center space-x-2">
          ...
          <!-- Dark Mode Toggle -->
          <button class="darkmode-toggle btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" >
            <svg
